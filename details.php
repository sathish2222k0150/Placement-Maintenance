...
$courses = $pdo->query("SELECT DISTINCT course_name FROM students WHERE course_name IS NOT NULL AND course_name != '' ORDER BY course_name")->fetchAll();
                    ...
                    <div class="page-header d-print-none export-btn-wrapper">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto ms-auto">
                                <a href="?export=excel&project_id=<?= $project_id ?>&batch_id=<?= $batch_id ?>&course_name=<?= urlencode($course_name) ?>" class="btn btn-primary">
                                    ...
                                    <form method="get" class="row g-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control" id="course_name" name="course_name" 
                                                   value="<?= htmlspecialchars($course_name) ?>" placeholder="Enter course name"
